 ...
 */
public class FilteringTableModelPopup extends JPopupMenu {
    protected FilteringTableColumnModel _model;
    protected ActionListener _actionListener;

    public FilteringTableModelPopup() {
        initialize();
    }
     ...
     */
    public FilteringTableModelPopup(final FilteringTableColumnModel mdl) {
        initialize();
        setModel(mdl);
    }
