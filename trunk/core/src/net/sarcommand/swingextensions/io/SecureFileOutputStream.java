 ...
 * the destination file and potentially destroying it, this implementation will preserve the destination file until
 * you 'commit' to the change by invoking close.
 * <p/>
...
public class SecureFileOutputStream extends OutputStream {
    ...
    /**
     * Disposes of this stream. You should invoke this method when writing to the output stream has failed to remove
     * the created temp file. After invoking dispose, the stream should be considered.
     *
