...
public class ManagedAction extends AbstractAction {
    /**
     * The token which should be used then assigning the menu keymask to accelerator keys. If you want to define
     * a platform independent accelerator key, you should for example use "menu c" rather than "control c" or
     * "meta c" for the copy action.
     */
    public static final String MENU_ACCELERATOR_TOKEN = "menu";

    /**
     * A grouping key used to define exclusive action groups. Only one item of an action group may be selected at
     * a time, so you can use the group key to implement toggle actions.
     */
    public static final String GROUP_KEY = "Group";

    /**
     * Defines which component should be used as root when creating the responder chain. See the javadoc for
     * the ActionManager class for details on his concept.
     */
     ...
     */
    public ManagedAction(final Object identifier) {
    ...
    public void actionPerformed(ActionEvent e) {
        ActionManager.actionPerformed(getIdentifier(), e);
    }
}
