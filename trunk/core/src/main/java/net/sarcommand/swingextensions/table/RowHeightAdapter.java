 ...
 * display all cells. Basically, a RowHeightAdapter will invoke the setPreferredRowHeights(...) method from TableUtil
 * whenever the table margins change or the model has been updated. You will probably want to install a RowHeightAdapter
 * if you are using complex table cell editors like the TextPaneTableCellEditor.
 * <p/>
