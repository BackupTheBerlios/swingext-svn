...
/**
 * This class implements a simple text-based icon. For several occasions it may come in handy to use unicode characters
 * (like 0x2460) as simple icons instead of having to create images and store those as external resources. Therefore,
 * this icon implementation will render a short text or rather a single character and can be used anywhere you would
 * normally use an {@link ImageIcon}.
 * <p/>
...
public class TextIcon implements Icon {
    ...
    /**
     * Creates a new text icon using the given font and color. Additionally, an alpha composite may be specified to make
     * the text icon translucent.
     *
