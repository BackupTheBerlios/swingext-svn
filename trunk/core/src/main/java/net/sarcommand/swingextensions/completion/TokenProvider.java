...
/**
 * Common interface for classes which extract a piece of text (a token) from a given text a specified position.
 * A token in this context might be a line, a word, a sentence, a semantical unit etc.
 * <p/>
 * <hr/>
