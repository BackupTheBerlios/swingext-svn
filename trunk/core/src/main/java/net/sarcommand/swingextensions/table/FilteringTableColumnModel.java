 ...
 * <p/>
 * <code> final JTable table = new JTable(); final FilteringTableColumnModel model = new FilteringTableColumnModel();
 * table.setColumnModel(model); table.getTableHeader().setComponentPopup(new FilteringTableColumnModelPopup(model));
 * </code>
 * <p/>
 * If you supply a preferences instance and key, the model will keep track of the visibility state of your columns
 * between sessions. <hr/> Copyright 2006-2012 Torsten Heup
 * <p/>
