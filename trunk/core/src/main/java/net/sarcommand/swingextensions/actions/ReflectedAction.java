...
/**
 * A ReflectedAction is an implementation of the ManagedAction concept which uses reflection to invoke a method when the
 * action is performed. It is created with a target object and the name of the method handling the action. By
 * convention, the method being notified has to meet one of the following two signatures: <li>(Object, ActionEvent), in
...
public class ReflectedAction extends AbstractAction {
     ...
     * @see javax.swing.Action#actionPerformed(java.awt.event.ActionEvent)
     */
