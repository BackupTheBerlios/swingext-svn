...
/**
 * Abstract super class for JTextField-based implementation of the TypedInputField interface. This implementation uses a
 * property editor to convert between the textual representation of data and the actual data type.
 * <p/>
...
public abstract class AbstractTypedTextField<E> extends JTextField implements TypedInputField<E> {
    ...
    /**
     * Sets the feedback object for this component. Whenever the input field's value changes, the feedback object will
     * be notified according to whether the new value is legal, illegal or possibly incomplete.
     *
