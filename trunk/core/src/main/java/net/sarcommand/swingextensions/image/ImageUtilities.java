...
public class ImageUtilities {
     ...
     * {@link ImageUtilities#applyGaussianBlur(java.awt.image.BufferedImage, int, float, boolean)}. The result of this
     * operation is then rendered below the original using a LookupTable.
     *
