...
public class KeyUtilities {
    ...
    public static void addFocusTraversalKey(final JComponent target, final int keyCode, final int modifiers,
                                            final int id) {
    ...
    public static void removeFocusTraversalKey(final JComponent target, final int keyCode, final int modifiers,
                                               final int id) {
