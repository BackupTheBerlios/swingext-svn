...
/**
 * This interface defines callback objects for use with the TypedInputField class. TypedInputFields are components
 * which restrict user input to a certain data type, such as Integers or email addresses. They use instances of
 * TypedInputFieldEditCallback to signal whether the currently entered value is legal or illegal with regards to their
 * type or whether it may become valid with futher input. For instance, in case of a DoubleInputField the value
 * "123" would be legal, "123.2e" would be incomplete and the input of character data would be rejected at all.
 * <p/>
 * <hr/>
